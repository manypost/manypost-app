          ...
          {Array.from({ length: 24 }, (_, hour) => {
            ...
            return (
              <div key={hour} className="grid" style={{ gridTemplateColumns: colsDesktop }}>
                <span
                  className={cn(
                    '-mt-2 border-r border-line px-2 pt-2 text-right text-axis tabular-nums text-mist transition-colors',
            ...
            {Array.from({ length: 24 }, (_, hour) => {
              ...
              return (
                ...
                >
                  <span
                    className={cn(
                      'border-b border-r border-line px-1.5 pt-2 text-right text-axis font-medium tabular-nums transition-colors',
