 ...
 *     design.md §6.3 existe como utility: text-axis/meta/compact/panel
...
const RULES: Array<{ rule: string; re: RegExp; skip?: (file: string) => boolean }> = [
  ...
  },
  {
    ...
    // (text-axis/meta/compact/panel + as do Tailwind). Acima de 16px vale o regime editorial do
    // §6.2, que usa `clamp()` e valor explícito de propósito — hero e títulos de marca.
    rule: 'tamanho de fonte arbitrário no regime compacto (use text-axis/meta/compact/panel — design.md §6.3/§43.20)',
