...
> **Origem e licença:** o núcleo do postaq é **derivado do [Postiz](https://github.com/gitroomhq/postiz-app)** (AGPL-3.0) — reimplementação das soluções dele em nova stack (Bun/TypeScript, Hono, Next.js, Drizzle/PostgreSQL, pg-boss, Redis). Por isso este repositório é **AGPL-3.0**, com atribuição preservada. Detalhes: [NOTICE](NOTICE) e [ATTRIBUTION.md](ATTRIBUTION.md).
...
| [docs/DECISIONS.md](docs/DECISIONS.md) | Decisões congeladas v1 (fronteira AGPL/premium, fila, stack) |
...
[AGPL-3.0](LICENSE). © contribuidores do postaq. Derivado do Postiz © Gitroom Holdings — ver [ATTRIBUTION.md](ATTRIBUTION.md).
